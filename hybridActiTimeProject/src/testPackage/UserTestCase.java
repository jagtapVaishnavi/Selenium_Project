...
public class UserTestCase extends BaseTest {
	...
	public void createUserMethod() throws IOException, EncryptedDocumentException, InterruptedException {
		...
		up.createManager(flib.readExcelData(EXCEL_PATH, MANAGERSHEET_NAME, 1, 0),
				flib.readExcelData(EXCEL_PATH, MANAGERSHEET_NAME, 1, 1),
				flib.readExcelData(EXCEL_PATH, MANAGERSHEET_NAME, 1, 2),
				flib.readExcelData(EXCEL_PATH, MANAGERSHEET_NAME, 1, 3));
		// delete the user
		// up.deleteManager();
